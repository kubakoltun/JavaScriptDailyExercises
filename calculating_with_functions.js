...
function plus(x, y) {return function(y) { return y+x;} }
function minus(x, y) {return function(y) { return y-x;} }
function times(x, y) {return function(y) { return y*x;} }
function dividedBy(x, y) {return function(y) { return Math.floor(y/x);} }
